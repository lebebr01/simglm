...
#' 
#' Power function to compute power for a regression term for the generalized linear mixed model.  This
#' function would need to be replicated to make any statement about power.  Use \code{\link{sim_pow_glm}}
...
sim_pow_glm_nested3 <- function(fixed, random, random3, fixed_param, 
  ...
  temp_nest <- sim_glm_nested3(fixed, random, random3, fixed_param, random_param, random_param3, 
                               cov_param, k, n, p, 
...
#' @param ... Not currently used.
#' @export 
sim_pow_glm_nested <- function(fixed, random, fixed_param, random_param = list(), cov_param, n, p, 
  ...
  temp_nest <- sim_glm_nested(fixed, random, fixed_param, random_param, cov_param, n, p, 
...
#' 
#' Power function to compute power for a regression term for simple generalized regression models.  This
#' function would need to be replicated to make any statement about power.  Use \code{\link{sim_pow_glm}}
#' as a convenient wrapper for this.
#' 
#' @seealso \code{\link{sim_pow_glm}} for a wrapper to replicate.
