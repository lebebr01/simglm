...
temp_single <- sim_glm(fixed = fixed, fixed.param = fixed.param, 
                       cov.param = cov.param, 
                       n = n, data_str = "single")
head(temp_single)
```
...
p <- 30
data_str <- "cross"
temp_cross <- sim_glm(fixed, random, random3 = NULL, fixed.param,
...
p <- 30
data_str <- "cross"
temp_three <- sim_glm(fixed, random, random3, fixed.param, random_param,
