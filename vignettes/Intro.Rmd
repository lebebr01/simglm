...
The rest of the arguments are pretty straightforward, `n` is the sample size, `error_var` is the error variance, `rand_gen` is the distribution of the residuals, and finally in the function call itself, `data_str` must be "single" in this instance to reflect a single level regression.
...
temp.single.o <- sim_reg(fixed = fixed, fixed.param = fixed.param, 
                         cov.param = cov.param, n = n, error_var = error_var,
                         rand_gen = rand_gen, data_str = "single", 
