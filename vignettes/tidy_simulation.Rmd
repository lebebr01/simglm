...
The other element that needs to be kept track of, is the order that these indicator attributes are created by R. The default behavior is for these to be created in alphabetical order. This is will be ... (to come), see [Issue 83](https://github.com/lebebr01/simglm/issues/83).
...
Notice how 3 additional parameters to the `reg_weights` argument were specified to reflect the 3 additional indicator attributes representing the 4 categorical grade groups simulated. 
