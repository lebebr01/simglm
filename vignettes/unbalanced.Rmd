...
with_err_gen <- 'rnorm'
data_str <- "cross"
unbal_design <- list(min = 3, max = 10)
temp_cross <- sim_reg(fixed = fixed, random = random, 
                      ...
                      unbal = TRUE, unbal_design = unbal_design)
```
...
temp_three <- sim_reg(fixed = fixed, random = random, random3 = random3,
      ...
      with_err_gen = with_err_gen, 
      data_str = data_str, unbal_design = unbal_design, unbalCont3 = unbalCont3)
```
